...
@Component({
  selector: 'app-customerreferalrequest',
  templateUrl: './customerreferalrequest.component.html',
  styleUrls: ['./customerreferalrequest.component.css']
})
export class CustomerreferalrequestComponent implements OnInit {
