...
@Component({
  selector: 'app-statemenuofaccount',
  templateUrl: './statemenuofaccount.component.html',
  styleUrls: ['./statemenuofaccount.component.css']
})
export class StatemenuofaccountComponent implements OnInit {
