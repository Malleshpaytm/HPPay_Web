...
@Component({
  selector: 'app-bankcreditlimitstatus',
  templateUrl: './bankcreditlimitstatus.component.html',
  styleUrls: ['./bankcreditlimitstatus.component.css']
})
export class BankcreditlimitstatusComponent implements OnInit {
