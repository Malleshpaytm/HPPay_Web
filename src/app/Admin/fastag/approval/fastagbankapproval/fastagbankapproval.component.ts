...
@Component({
  selector: 'app-fastagbankapproval',
  templateUrl: './fastagbankapproval.component.html',
  styleUrls: ['./fastagbankapproval.component.css']
})
export class FastagbankapprovalComponent implements OnInit {
