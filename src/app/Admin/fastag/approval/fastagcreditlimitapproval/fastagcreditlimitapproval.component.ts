...
@Component({
  selector: 'app-fastagcreditlimitapproval',
  templateUrl: './fastagcreditlimitapproval.component.html',
  styleUrls: ['./fastagcreditlimitapproval.component.css']
})
export class FastagcreditlimitapprovalComponent implements OnInit {
