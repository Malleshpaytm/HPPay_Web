...
@Component({
  selector: 'app-dealerearningreport',
  templateUrl: './dealerearningreport.component.html',
  styleUrls: ['./dealerearningreport.component.css']
})
export class DealerearningreportComponent implements OnInit {
