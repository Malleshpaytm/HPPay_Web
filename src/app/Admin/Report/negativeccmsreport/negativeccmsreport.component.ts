...
@Component({
  selector: 'app-negativeccmsreport',
  templateUrl: './negativeccmsreport.component.html',
  styleUrls: ['./negativeccmsreport.component.css']
})
export class NegativeccmsreportComponent implements OnInit {
